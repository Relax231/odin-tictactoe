...
playerOne = {
    ...
    playerChoice : function(){
        ...
        let playerChoice = "";
        while (!playerChoice){
            let playerPrompt = prompt("Pick rock, paper, scissors!").toLowerCase().trim()
...
while(computerPlayer.score <=5 && playerOne.score <=5){
    if(computerPlayer.score === 5){
        ...
        break;
            ...
            alert(`${checkWinner(playerOne.playerChoice(), computerPlayer.computerChoice())}\nPlayer Score: ${playerOne.score} \nComputer Score: ${computerPlayer.score}\n`)
        }
}
}
